...
function getVendorDetails() {
	$("#deleteButtonID").hide();
	var strUrl = 'http://192.168.1.106:2000/FleetManagement/contactUsersController/getVendorList';
	console.log("" + strUrl);
	$.ajax({
		type : 'GET',
		url : strUrl,
...
function searchVendorDetails1() {
	...
	var strUrl = "http://192.168.1.106:2000/FleetManagement/contactUsersController/searchVendorDetails1";
	$.ajax({
		type : "POST",
		url : strUrl,
		dataType : "json",
