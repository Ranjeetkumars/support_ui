        ...
        success: function(data) {
            if (data.responseCode == 200 || data.responseCode == '200' ) {
               ...
               // $('#registration').modal('toggle');
                ...
                showNotificationError("Not Save", "baselocationRegistrationId", "error");
...
function loadBaselocationList(strData) {
    ...
    $(objTHead121).html('<label class="check "><span style=" color: white">Select</span> <input type="checkbox" id="selectall" onclick="test()">  <span class="checkmark"></span>');
   ...
   // $(objTHead121).html('<input type="checkbox" id="selectall" onclick="test()">');
    ...
    for (var i = 0; i < strData.length; i++) {
        ...
        $(tablcol120).html('<label class="check "><input type="checkbox" class="baselocation" id="ch_baseID"  value=' + strData[i].baselocationId + ' name="baselocation"  )" ><span class="checkmark"> </label>');
