...
//var SYSTEM_IP1 = "52.172.54.113:9031/FleetManagement";

var SYSTEM_IP = "localhost:9031";
var SYSTEM_IP1 = "localhost:9031/FleetManagement";




var SYSTEM_IP2 = "localhost:3000";
//var SYSTEM_IP = "104.211.220.120:9161";
//var SYSTEM_IP1 = "104.211.220.120:9161/FleetManagement";
 ...
 Service = {
    ...
    //service history
    getAllServiceHistory: 'http://' + SYSTEM_IP + '/FleetManagement/ServiceRegistationController/getServiceHistoryDetails',
    saveaNewServiceEntry: 'http://' + SYSTEM_IP + '/FleetManagement/ServiceRegistationController/saveServiceHistoryDetails',
    
    getVendor: 'http://' + SYSTEM_IP + '/FleetManagement/contactUsersController/getVendorList',
    
    serviceHistoryDeletion: 'http://' + SYSTEM_IP + '/FleetManagement/ServiceRegistationController/DeleteServiceHistoryDetails',
    ...
    //Fuel
    	     ViewImage: 'http://' + SYSTEM_IP2 + '/FileController/uploadFile/',
    
     FUEL_GETVEHICLES_DROPDOWN: 'http://' + SYSTEM_IP2 + '/FileController/uploadFile/',
    FUEL_GETVEHICLES_DROPDOWN: 'http://' + SYSTEM_IP1 + '/CommonDataController/getAvailableVehicles',
    loadVehicleType1: 'http://' + SYSTEM_IP1 + '/supervisor_cls_level/loadVehicleType',
    getFuelList: 'http://' + SYSTEM_IP1 + '/fuelController/getFuelRegisterFuelDetails',
    loadListOfStation: 'http://' + SYSTEM_IP1 + '/fuelController/getFuelStationsDropDown',
    StationAddress: 'http://' + SYSTEM_IP1 + '/fuelController/getFuelAddrssBasedOnStationId',
    listOfPaymentMode: 'http://' + SYSTEM_IP1 + '/fuelController/gettPaymentDetails',
    listOfFleetCardDropdown: 'http://' + SYSTEM_IP1 + '/fuelController/getFleetCardDropdown',
    saveFuelDetails: 'http://' + SYSTEM_IP1 + '/fuelController/insertFuelFillingDetails',
  //  loadFuelTypes: 'http://' + SYSTEM_IP_1 + '/supervisor_cls_level/loadFuelType',
    
    
    //issue
    saveIssuesDetails: 'http://' + SYSTEM_IP1 + '/issuesController/insertAndUpdateIssues',
    updateIssues: 'http://' + SYSTEM_IP1 + '/issuesController/insertAndUpdateIssues',
    deleteIssuesDetails: 'http://' + SYSTEM_IP1 + '/issuesController/insertAndUpdateIssues',
    searchIssuesList: 'http://' + SYSTEM_IP1 + '/issuesController/searchIssuesDetails',
    getIssuesList: 'http://' + SYSTEM_IP1 + '/issuesController/getIssuesList',
