...
function get_vehicleList() {
    ...
    try {
        ...
        if (registerNumber1 === '0' || registerNumber1 === "Select Register No") {
...
function updateVehicleDetails() {
   ...
   // var purchaseDate = $("#up_strtDate").val();
    ...
    var purchaseDate1 = $("#up_strtDate").val();
    var d = new Date(purchaseDate1.split("-").reverse().join("-"));
    var dd = d.getDate();
    var mm = d.getMonth() + 1;
    var yy = d.getFullYear();
    purchaseDate1 = yy + "-" + mm + "-" + dd;
    ...
    $.ajax({
        ...
        success: function (data) {
            var responseCode = data.responseCode;
            if (200 !== responseCode) {
                showNotificationError("Vehicle Details not  Update", "updateVehicleId", "error");

            } else {
            
                showNotificationError("Vehicle Details Updated Successfully", "updateVehicleId", "success");
