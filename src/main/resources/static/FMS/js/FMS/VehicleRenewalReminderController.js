...
function getRenewalRemindersList() {
    ...
    try {
        var reminderStatus;
        reminderStatus = $('#reminderStatusId').val();
        var vehicleName;
        vehicleName = $('#vehicleNameId :selected').text();

          var registerNumber ;
          registerNumber = $('#registerNumberId :selected').text();
           var dueDate ;
           dueDate = $('#strtDate1').val();
    // var searchDate = $('#strtDate').val();
        var searchDate = $("#strtDate1").val();
        ...
        var syy = "¥";
        if (vehicleName === 'Please Select vehicle' ||vehicleName === "Please Select vehicle" ||  vehicleName === 0) {

            vehicleName = syy;

        }
        if (registerNumber === 'Select Register No' ||registerNumber === "Select Register No" || registerNumber === 0) {
