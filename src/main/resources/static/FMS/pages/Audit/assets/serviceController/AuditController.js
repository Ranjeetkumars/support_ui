...
function getAuditDetailsReport11() {
    ...
    try {
        var json_GetAudit_Details1 = {
           // "auditId":auditIDD,
           //  "sessionId":sectionName,
           // "availableId":availableStatus ,
             //"functionalId":functionalStatus, 
             
             "auditId":"2019121307458","sessionId":"0","availableId":0,"functionalId":0,    
        };
        
        
        //{"auditId":"2019121307458","sessionId":"0","availableId":0,"functionalId":0}
        var strUrl = Service.getAuditDetailsReport;
    console.log("::::::::::::::::::::::kkkkkkkk:::::::::::::::::::"+JSON.stringify(json_GetAudit_Details1));
    console.log("::::::::::::::::::::::::::::::lllllllllllll::::::::::"+strUrl);
        $.ajax({
            type: "POST",
            url: strUrl,
            dataType: "json",
            data: JSON.stringify(json_GetAudit_Details1),
            contentType: "application/json",
            async: false,
            crossDomain: true,
            headers: {
