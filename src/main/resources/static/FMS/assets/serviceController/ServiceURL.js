...
var SYSTEM_IP2="52.172.54.113:9031";
var SYSTEM="52.172.54.113:9031";
 ...
 Service = {
  ...
  //  loadFuelTypes: 'http://' + SYSTEM_IP_1 + '/supervisor_cls_level/loadFuelType',
    ...
    getUser:'http://'+SYSTEM_IP2+'/FleetManagement/issuesController/getUser',
    ...
    //vendor
    getVendorDetails:'http://'+SYSTEM_IP1+'/contactUsersController/getVendorList',
    searchVendorDetails1:'http://'+SYSTEM_IP1+'/contactUsersController/searchVendorDetails1',
    
    //contact
    getContactUsers:'http://'+SYSTEM_IP1+'/contactUsersController/getContactList',
    searchContactUsers:'http://'+SYSTEM_IP1+'/contactUsersController/searchContactDetails',
    getUserRoles:'http://'+SYSTEM_IP1+'/contactUsersController/getUserRoles',
