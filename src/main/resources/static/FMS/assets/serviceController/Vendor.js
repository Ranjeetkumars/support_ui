...
function getVendorDetails() {
	$("#deleteButtonID").hide();
	var strUrl = Service.getVendorDetails;
	//var strUrl = 'http://104.211.220.120:9162/FleetManagement/contactUsersController/getVendorList';
	console.log("" + strUrl);
	$.ajax({
		type : 'GET',
		url : strUrl,
...
function searchVendorDetails1() {
	...
	var strUrl = Service.searchVendorDetails1;
	//var strUrl =searchVendorDetails1 "http://104.211.220.120:9162/FleetManagement/contactUsersController/searchVendorDetails1";
	$.ajax({
		type : "POST",
		url : strUrl,
		dataType : "json",
