...
//Login
function loginQuality() {
    var username = $('#usernameid').val();
    var password = $('#passwordid').val();
    var objJson = {
        "username": username,
        "password": password,
        "localIp": "192.168.1.215",
        "publicIp": "192.168.1.215",
        "siteID": "34",
...
//				}else{
            ...
            if (module_id === "9" && role_id === "162" && user_id !== null && token_id === tokenid) {
                window.location.href = "D:/GIT_PROJECT_REPO/pro_quality_ui/web/dashboard.html";
            } else {
                $('#toastid').show();
                window.setTimeout(function() {
                    $('#toastid').hide();
...
function logout() {
    ...
    if (module_id === null && user_id === null && role_id === null && token_id === null) {
        window.location.href = "D:/GIT_PROJECT_REPO/pro_quality_ui/web/login.html";
    }
