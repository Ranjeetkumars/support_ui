...
function loginWithPwd() {
  ...
  console.log('JSON OBJECT-----> '+JSON.stringify(userDetails));
...
//                    var srpName = list.username;
//                    var userId = list.userid;
//                    localStorage.setItem('Lobject', list);
...
function isUser_LoginorNot() {
    ...
    if (userId === undefined || userId === null || userId === 'null' || userId.length === null || userId.length === '0') {
        window.location.href = 'http://localhost:2800/admin/admin/login.html';
